  ...
  return (
    <div className="px-4 py-6 max-w-md mx-auto text-sm bg-[#f9f9fb] min-h-screen">
      <div className="mb-3 text-gray-600 text-sm leading-relaxed">
        ...
        Pastikan alamat tersebut sesuai dengan jaringan{" "}
        {data.network.toLowerCase()} dan jenis koin {data.quoteCoinSymbol}.
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4">
        ...
        <div className="bg-gray-100 rounded-xl px-4 py-3 mb-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">
              You get ~ {data.receiveAmount} {data.quoteCoinSymbol}
            </p>
          </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
          <p className="text-xs text-yellow-800">
            ⚠️ Please make sure the address supports {data.quoteCoinSymbol} on{" "}
            {data.network}. Sending to a wrong address may result in permanent
            loss of funds.
          </p>
        </div>
